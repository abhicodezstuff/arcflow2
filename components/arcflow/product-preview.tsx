...
export function ProductPreview() {
  return (
    <section className="relative bg-[#09090B]/30 py-20 sm:py-32">
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        {/* Product window */}
        <div className="mx-auto mt-16 max-w-6xl overflow-hidden rounded-2xl border border-white/[0.1] bg-[#0F1012]/70 shadow-2xl shadow-black/30 backdrop-blur-sm">
          {/* Top bar */}
          ...
          <div className="flex min-h-[560px]">
            {/* Sidebar */}
            <aside className="hidden w-56 shrink-0 border-r border-white/[0.06] bg-[#0F1012]/40 p-4 md:block">
              ...
              <div className="space-y-6 p-5 sm:p-6">
                ...
                <div className="rounded-xl border border-white/[0.07] bg-white/[0.02]">
                  ...
                  <div className="space-y-3 p-4">
                    <div className="flex items-center gap-3 rounded-lg border border-white/[0.06] bg-[#151619]/60 p-3 backdrop-blur-sm">
                    ...
                    <div className="flex items-center gap-3 rounded-lg border border-[#5B7CFF]/25 bg-[#10121A]/70 p-3 backdrop-blur-sm">
          ...
          {/* Caption */}
          <div className="border-t border-white/[0.06] bg-[#0F1012]/30 px-5 py-4 text-center">
