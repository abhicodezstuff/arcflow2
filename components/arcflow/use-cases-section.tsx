  ...
  return (
    <section className="border-t border-white/[0.06] bg-[#09090B]/30 py-24 sm:py-32">
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="mt-16 grid gap-4 lg:grid-cols-2">
          {useCases.slice(0, 4).map((useCase) => {
            ...
            return (
              <div
                key={useCase.title}
                className="group rounded-2xl border border-white/[0.08] bg-[#0F1012]/60 p-7 transition-colors duration-300 hover:border-white/[0.12] hover:bg-[#121316]/70 sm:p-8"
              >
                ...
                <div className="mt-7 rounded-lg border border-white/[0.06] bg-[#09090B]/60 px-4 py-3">
        ...
        {/* Final use case */}
        <div className="mt-4 rounded-2xl border border-white/[0.08] bg-[#0F1012]/60 p-7 sm:p-8">
